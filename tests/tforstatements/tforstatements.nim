...
ERROR: rule: forstatements, for statement, line: 1 don't use 'pairs' or 'items' for iterators.
...
ERROR: rule: forstatements, for statement, line: 1 uses 'items' for iterators.
...
NOTICE: rule: forstatements, For statements which can be upgraded not found.
INFO: Checking search type of the rule with the valid code.
NOTICE: rule: forstatements, for statement, line: 1 don't use 'pairs' or 'items' for iterators.
INFO: Checking negative search type of the rule with the valid code.
NOTICE: rule: forstatements, For statements which can't be upgraded not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: rule: forstatements, for statement, line: 1 uses '' for iterators.
...
NOTICE: rule: forstatements, for statement, line: 1 uses 'items' for iterators.
