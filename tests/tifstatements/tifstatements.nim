...
ERROR: rule: ifstatements, if statement, line: 1 starts with a negative condition.
...
ERROR: rule: ifstatements, if statement, line: 1 the statement branch doesn't contain only discard statement.
...
NOTICE: rule: ifstatements, if statement, line: 1 the statement branch contains only discard statement.
...
NOTICE: rule: ifstatements, If statements which can't be upgraded not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: rule: ifstatements, if statement, line: 1 doesn't start with a negative condition.
