...
ERROR: if statement, line: 1 the statement branch doesn't contain only discard statement.
...
NOTICE: if statement, line: 1 the statement branch contains only discard statement.
...
NOTICE: if statement, line: 1 doesn't start with a negative condition.
