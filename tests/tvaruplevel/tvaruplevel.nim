...
ERROR: rule: varuplevel, declaration of 'b' line: 3 can be updated to constant.
...
ERROR: rule: varuplevel, declaration of a line: 1 can't be updated to let.
...
NOTICE: rule: varuplevel, declaration of a line: 1 can't be updated to let.
...
NOTICE: rule: varuplevel, Declarations which can't be upgraded not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: rule: varuplevel, declaration of 'b' line: 3 can be updated to constant.
