...
ERROR: rule: casestatements, case statement, line: 1 the statement has less than 2 branches.
...
ERROR: rule: casestatements, case statement, line: 1 the statement doesn't have less than 2 branches.
...
NOTICE: rule: casestatements, Case statements which can be upgraded not found.
INFO: The test for searching for invalid code is disabled.
INFO: Checking search type of the rule with the valid code.
NOTICE: rule: casestatements, case statement, line: 1 the statement has less than 2 branches.
INFO: Checking negative search type of the rule with the valid code.
NOTICE: rule: casestatements, Case statements which can't be upgraded not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: rule: casestatements, case statement, line: 1 the statement doesn't have less than 2 branches.
