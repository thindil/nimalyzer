...
ERROR: rule: assignments, assignments to 'i' line: 2 can be updated to a shorthand assignment.
...
ERROR: rule: assignments, assignments to 'i' line: 2 can be updated to a full assignment.
...
NOTICE: rule: assignments, Assignments which are shorthand assigments not found.
INFO: Checking search type of the rule with the valid code.
NOTICE: rule: assignments, assignments to 'i' line: 2 is a shorthand assignment.
INFO: Checking negative search type of the rule with the valid code.
NOTICE: rule: assignments, Assignments which are't shorthand assigments not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: rule: assignments, assignments to 'i' line: 2 is a full assignment.
