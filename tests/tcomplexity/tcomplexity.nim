...
ERROR: Code block at line: 1 has cyclomatic complexity more than 2 (3).
...
ERROR: Code block at line: 1 has cyclomatic complexity less or equal to 2 (2).
...
NOTICE: Code blocks with the complexity less or equal to the selected not found.
INFO: Checking search type of the rule with the valid code.
NOTICE: Code block at line: 1 has cyclomatic complexity less or equal to 2 (2).
INFO: Checking negative search type of the rule with the valid code.
NOTICE: Code blocks with the complexity more than the selected not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: Code block at line: 1 has cyclomatic complexity more than 2 (3).
