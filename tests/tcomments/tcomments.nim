...
ERROR: rule: comments, Comment at line: 1 doesn't match the pattern '^FIXME'.
...
ERROR: rule: comments, Comment at line: 1 match the pattern '^FIXME'.
...
NOTICE: rule: comments, Comments which match the pattern not found.
INFO: Checking search type of the rule with the valid code.
NOTICE: rule: comments, Comment at line: 1 match the pattern '^FIXME'.
INFO: Checking negative search type of the rule with the valid code.
NOTICE: rule: comments, Comments which doesn't match the pattern not found.
INFO: Checking negative search type of the rule with the invalid code.
NOTICE: rule: comments, Comment at line: 1 doesn't match the pattern '^FIXME'.
